      ...
      body: Consumer<SettingsProvider>(
        builder: (context, settings, child) => ListView(
          ...
          children: [
            ...
            _sectionTitle(t(AppStrings.languageEn, AppStrings.languageHi)),
            Card(
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
              child: Column(
                children: [
                  SwitchListTile(
                    title: Text(t(AppStrings.largeTextModeEn, AppStrings.largeTextModeHi)),
                    subtitle: const Text('Easier to read for elderly users'),
                    value: settings.largeTextMode,
                    onChanged: (v) => settings.setLargeTextMode(v),
