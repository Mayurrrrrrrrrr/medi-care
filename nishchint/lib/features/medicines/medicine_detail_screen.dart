...
import '../../data/models/care_note_model.dart';
...
class _MedicineDetailScreenState extends State<MedicineDetailScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      // Load care notes
      _careNotes = await _api.getCareNotes(widget.medicineId);
    } catch (e) {
  ...
  Future<void> _addNote() async {
    ...
    try {
      final note = await _api.addCareNote(widget.medicineId, _noteController.text.trim());
      setState(() {
      ...
      children: [
        ...
        if (_careNotes.isEmpty)
          Container(
            ...
            child: const Center(
              child: Text(
                "No care notes yet. Add instructions from your doctor or family here.",
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        DateFormat('MMM d, h:mm a').format(DateTime.parse(note.createdAt)),
