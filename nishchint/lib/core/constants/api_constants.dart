class ApiConstants {
  ...
  // Notes
  static const String notesAdd = '$baseUrl/notes/add.php';
  static String notesIndex(int medicineId) => '$baseUrl/notes/index.php?medicine_id=$medicineId';

  // Reports
  static const String doctorReport = '$baseUrl/reports/doctor_report.php';
}
